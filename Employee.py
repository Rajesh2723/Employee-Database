...
def addemployee():
    ...
    #<<<------------------- creating window for Retainer entry --------------------->>>#    
...
########################################  END OF DEFINING UPDATERetainer ###############################################
...
#------------------------------------ MAIN LABEL/HEADING
main_label = Label(root, text="Employee table", relief="groove", bg="#FFFDD0", fg="navy blue",
                   font=("arial", 22, "bold"))
